        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30">
                <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm font-semibold text-orange-600 dark:text-orange-400">Delivered within 24 hours!</span>
              </div>
              
              <p className="text-foreground/80 leading-relaxed mb-6">
                Worked with a BPO & outsourcing company to bring their business online through a modern, professional website. The client needed the website completed within 24 hours, and I delivered on time. The goal was to create a strong first impression and make it easy for potential clients to understand services and reach out.
              </p>
              
              <div className="pt-6 border-t border-foreground/10">
                <h3 className="text-lg font-semibold mb-4 text-foreground">Impact</h3>
                <p className="text-foreground/80 leading-relaxed">
                  Created a professional online presence and turned the website into a working client inquiry channel — all within the tight 24-hour deadline.
                </p>
              </div>
            </div>
          </motion.div>
