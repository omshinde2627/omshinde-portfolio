  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(14 100% 55% / 0.3), 0 0 40px hsl(24 100% 60% / 0.15)" },
          "50%": { boxShadow: "0 0 40px hsl(14 100% 55% / 0.6), 0 0 80px hsl(24 100% 60% / 0.3)" },
        },
        float: {
      ...
      animation: {
        ...
        "glow-pulse": "glow-pulse 3s cubic-bezier(0.22, 1, 0.36, 1) infinite",
        ...
        "slide-down": "slide-down 0.8s cubic-bezier(0.22, 1, 0.36, 1) both",
      },
